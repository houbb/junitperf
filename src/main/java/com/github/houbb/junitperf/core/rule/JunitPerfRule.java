...
public class JunitPerfRule implements TestRule {
    ...
    public Statement apply(Statement statement, Description description) {
        ...
        if(ObjectUtil.isNotNull(junitPerfConfig)) {
            ...
            activeStatement = new PerformanceEvaluationStatement(evaluationContext,statement, statisticsCalculator,
                    reporterSet, ACTIVE_CONTEXTS.get(description.getTestClass()));
        }
